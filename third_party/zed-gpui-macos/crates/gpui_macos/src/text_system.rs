    ...
    fn rasterize_glyph(
        ...
        if glyph_bounds.size.width.0 == 0 || glyph_bounds.size.height.0 == 0 {
            ...
            if params.dilation > 0 {
                ...
                // This bitmap is uploaded as a glyph alpha mask. Some older
                // macOS CoreGraphics paths leave alpha-only glyph bitmaps
                // transparent when drawing with gray 0, so draw opaque white.
